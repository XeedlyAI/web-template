...
5. Read the skill files — canonical copies live in the XeedlyAI library at `..\standards` (this template no longer carries local copies):
   ...
   - **Advanced Design Skills** (library `standards\` folder; read when brief requires high design quality):
     - `standards\ANIMATION.md` — Motion design patterns, timing constants, scroll animations
     - `standards\SVG-VISUALS.md` — Code-generated graphics, product mockups, data visualizations
     - `standards\LAYOUT.md` — Advanced composition patterns, bento grids, sticky scroll
     - `standards\TYPOGRAPHY.md` — Font pairing, text hierarchy, phrase highlighting, responsive type
     - `standards\INTERACTIVE.md` — Premium interactive components, tabs, accordions, toggles
